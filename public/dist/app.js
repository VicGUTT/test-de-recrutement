...
/* harmony export */ });
/* harmony import */ var _search_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search-form */ "./resources/js/components/search-form.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  'search-form': _search_form__WEBPACK_IMPORTED_MODULE_0__["default"]
});

/***/ }),

/***/ "./resources/js/components/search-form.js":
/*!************************************************!*\
  !*** ./resources/js/components/search-form.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (el) {
  ...
  function onSuccessfullRequest(response) {
    var fragment = (0,_utils_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])(response.data);
    [ERROR_ID, RESULT_ID].forEach(function (ID) {
      var element = document.querySelector(ID);
      var target = fragment.querySelector(ID);
...
var Ajax = /*#__PURE__*/function () {
  ...
  _createClass(Ajax, [{
    ...
    key: "go",
    value: function () {
      var _go = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
        var options,
            opts,
            data,
            response,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data = this.makeData(opts);
                _context.next = 5;
                return fetch(this.makeRequestUrl(url, opts.method, data), {
                  method: opts.method,
    ...
    key: "makeRequestUrl",
    value: function makeRequestUrl(url, method, data) {
      if (method !== METHODS.GET) {
        return url;
      }
    ...
    key: "makeRequestHeaders",
    value: function makeRequestHeaders(options) {
      return _objectSpread(_objectSpread({}, options.headers), {}, {
    ...
    key: "throwIfResponseNotOk",
    value: function throwIfResponseNotOk(result) {
...
/***/ "./resources/js/utils/createElement.js":
/*!*********************************************!*\
  !*** ./resources/js/utils/createElement.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
